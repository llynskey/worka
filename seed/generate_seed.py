"""Generate seed.sql (+ cleanup.sql) for the Worku production demo dataset.
...
Every seeded account uses an @seed.worku.site email so cleanup.sql can remove the
...
PASSWORD = "WorkuDemo123!"
SEED_DOMAIN = "seed.worku.site"
...
parts = ["-- Worku demo seed. Generated by seed/generate_seed.py. Run ONCE.\n",
...
cleanup = f"""-- Remove the entire Worku demo dataset (everything under @{SEED_DOMAIN}).
BEGIN;
